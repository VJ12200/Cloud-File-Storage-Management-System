...
logging.level.software.amazon.awssdk=DEBUG
```
[Document.txt](src/Documentation/Document.txt) includes and explanation of most of the features along with issues I faced in development and their solutions.
